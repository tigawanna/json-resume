...
export function LandingHero() {
  return (
    ...
    >
      ...
      <div className="pointer-events-none relative z-10 px-6 pt-10 md:px-12 md:pt-14">
      ...
      <div className="pointer-events-none relative z-10 grid grid-cols-1 lg:grid-cols-12">
        <div className="flex flex-col justify-start gap-8 px-6 pt-8 pb-12 md:px-12 lg:col-span-5 lg:border-r lg:border-border/50 lg:pt-10 lg:pb-16">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link
              ...
              className="pointer-events-auto border border-border bg-base-100/80 px-6 py-3 font-mono text-sm text-base-content transition-colors hover:bg-neutral active:scale-[0.98]"
            >
              Sign in to sync
            </Link>
          </div>
        ...
        <div className="flex flex-col justify-start gap-6 border-t border-border/50 bg-base-100/80 px-6 py-8 md:px-10 lg:col-span-7 lg:border-t-0">
                ...
                <ul>
                  {version.ids.map((id) => {
                    ...
                    return (
                      ...
                      >
                        <span className="mr-2 font-mono text-xs text-primary">{part.kind}</span>
                        {part.title}
                      </li>
                    );
                  })}
