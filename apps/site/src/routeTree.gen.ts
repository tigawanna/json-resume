...
const DashboardResumesCreateIndexRoute = DashboardResumesCreateIndexRouteImport.update({
  id: "/resumes/create/",
  path: "/resumes/create/",
  getParentRoute: () => DashboardLayoutRoute,
} as any);
...
const DashboardReposPinnedIndexRoute = DashboardReposPinnedIndexRouteImport.update({
  id: "/repos/pinned/",
  path: "/repos/pinned/",
  getParentRoute: () => DashboardLayoutRoute,
} as any);
